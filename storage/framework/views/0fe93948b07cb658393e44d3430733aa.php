<?php echo e(Form::open(array('url'=>'section','method'=>'post'))); ?>
    ...
    <div class="row ">
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <?php echo e(Form::select('unit_id',$unit,null,array('class'=>'form-control select','placeholder'=>__('Select Unit'),'required'=> 'required'))); ?>
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('name',null,array('class'=>'form-control','placeholder'=>__('Enter Section Name'),'required'=> 'required'))); ?>
...
<?php /**PATH C:\xampp\htdocs\erp\resources\views/section/create.blade.php ENDPATH**/ ?>