                                            ...
                                            <div class="color-wrp">
                                                ...
                                                <div class="color-picker-wrp">
                                                    <input type="color" value="<?php echo e($color ? $color : ''); ?>"
                                                        ...
                                                        title="<?php echo e(__('Select Your Own Brand Color')); ?>"
                                                        id="color-picker">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <select type="text" name="timezone" class="form-control custom-select"
                                        ...
                                        <?php $__currentLoopData = $timezones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $timezone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($k); ?>"
                                                <?php echo e(isset($setting['timezone']) && $setting['timezone'] == $k ? 'selected' : ''); ?>><?php echo e($timezone); ?>
                                ...
                                <div
                                    class="form-group col-md-6 tax_type_div <?php echo e(isset($setting['vat_gst_number_switch']) && $setting['vat_gst_number_switch'] != 'on' ? ' d-none ' : ''); ?>">
                                    <div class="row">
                                        <div class="col-md-6">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <?php echo e(Form::text('zkteco_api_url', !empty($setting['zkteco_api_url']) ? $setting['zkteco_api_url'] : '', ['class' => 'form-control ', 'placeholder' => 'ZKTeco Api URL', 'required' => 'required'])); ?>
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <?php echo e(Form::text('username', !empty($setting['username']) ? $setting['username'] : '', ['class' => 'form-control ', 'placeholder' => 'Username', 'required' => 'required'])); ?>

                                    </div>
                                    <div class="col-md-3 form-group">
                                        <?php echo e(Form::label('user_password', __('Password'), ['class' => 'col-form-label'])); ?>

                                        <?php echo e(Form::text('user_password', !empty($setting['user_password']) ? $setting['user_password'] : '', ['class' => 'form-control ', 'placeholder' => 'Password', 'required' => 'required'])); ?>

                                    </div>
                                    <div class="col-md-8 form-group">
                                        <?php echo e(Form::label('auth_token', __('Auth Token'), ['class' => 'form-label'])); ?>

                                        <?php if(empty($setting['auth_token'])): ?>
                                            <small class="text-danger">
                                                <?php echo e(__('Please first generate auth token.')); ?>

                                            </small>
                                        <?php endif; ?>
                                        <?php echo e(Form::textarea('', !empty($setting['auth_token']) ? $setting['auth_token'] : null, ['class' => 'form-control font-style', 'disabled' => 'disabled', 'rows' => 3])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/settings/company.blade.php ENDPATH**/ ?>