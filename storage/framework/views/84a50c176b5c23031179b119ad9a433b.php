<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="<?php echo e(route('section.index')); ?>" class="list-group-item list-group-item-action border-0 <?php echo e((request()->is('section*') ? 'active' : '')); ?>"><?php echo e(__('Section')); ?><div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
